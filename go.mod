...
replace github.com/goccy/go-zetasqlite => github.com/slashid/go-zetasqlite v0.19.3-slashid-0.1.0

replace github.com/goccy/go-zetasql => github.com/slashid/go-zetasql v0.5.5-slashid-0.2.0
